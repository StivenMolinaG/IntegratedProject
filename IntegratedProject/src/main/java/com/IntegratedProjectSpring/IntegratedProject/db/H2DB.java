...
public class H2DB {
    ...
    private static final String CREATE_TABLE_PACIENTE = "CREATE TABLE IF NOT EXISTS PATIENT (id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255), lastName VARCHAR(255), " +
            "address VARCHAR(255)," +
            "DNI varchar(255)," +
            "dateOut Date)";
